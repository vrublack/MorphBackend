var questions = {
    Economy: [{
        q: 'The federal government should increase minimum wage...',
        l1: 'not at all',
        l5: 'to 15 dollars',
        t1: 3,
        c1: 0,
    ...
    Social_issues: [{
        q: 'Abortion should be...',
        l1: 'illegal in all cases, including rape and incest',
        l5: 'legalized',
        t1: 7,
        c1: 1,
        t5: 3,
        ...
        {
            q: 'The federal government should mandate universal background checks for all gun purchasers',
            t1: 8,
            c1: 0,
            t5: 1,
            c5: 9
    ...
    Foreign_policy: [{q: 'The U.S. should declare war on ISIS and send in ground troops.', t1: 0, c1: 2, t5: 10, c5: 8},
        {
            q: 'When considering foreign conflicts, the U.S. should...',
            l1: 'attempt to maintain balances of power.',
            l5: 'only become involved for self-defense',
            t1: 0,
            c1: 10,
            t5: 10,
            c5: 0
        ...
        {
            q: 'The government should _______ foreign aid spending.',
            l1: 'decrease',
            l5: 'increase',
            t1: 10,
            c1: 0,
    ...
    Immigration: [{
        q: 'The federal government should deal with illegal immigrants without criminal records by...',
        l1: 'creating a path to citizenship',
        l5: 'deporting them',
        t1: 0,
        c1: 0,
        t5: 10,
        ...
        {
            q: "Immigrants of a certain race or religion pose a threat to the country's domestic welfare and should be banned accordingly.",
            t1: 10,
            c1: 0,
            t5: 0,
            c5: 10
    ...
    Healthcare: [{
        q: 'The government should regulate prices for...',
        l1: 'no drugs',
        l5: 'all prescription drugs',
        t1: 0,
        c1: 0,
        t5: 10,
        c5: 10
    ...
    Environment: [{
        q: 'The government should provide tax credits and subsidies for companies seeking alternate energy sources.',
        t1: 10,
        c1: 0,
        t5: 0,
        c5: 10
        ...
        {
            q: 'The government should increase environmental regulations that mitigate the effects of climate change.',
            t1: 0,
            c1: 0,
            t5: 10,
            c5: 10
